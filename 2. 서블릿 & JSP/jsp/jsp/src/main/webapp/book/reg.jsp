...
<style>
	...
	.w-10{width: 10%}
	.w-15{width: 15%}
	.w-20{width: 20%; justify-content: center;}
</style>
</head>
<body>
			...
			<div class="card shadow mb-4">
				...
				<form action="/book/regFileupload" 
					...
					<div class="input-group mb-3">
						<span class="w-5 input-group-text" id="basic-addon1">도서명</span>
						<input type="text" class="form-control" placeholder="도서명" name="title" aria-label="Username" aria-describedby="basic-addon1">
					</div>
	
					<div class="input-group mb-3">
						<span class="w-10 input-group-text" id="basic-addon1">작가명</span>
					...
					<div class="input-group mb-3">
						<span class="w-20 input-group-text" id="basic-addon1">표지페이지</span>
